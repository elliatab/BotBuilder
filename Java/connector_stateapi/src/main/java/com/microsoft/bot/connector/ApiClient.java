...
import com.microsoft.bot.connector.auth.HttpBasicAuth;
import com.microsoft.bot.connector.auth.ApiKeyAuth;
import com.microsoft.bot.connector.auth.OAuth;
import com.microsoft.bot.connector.auth.OAuth.AccessTokenListener;
import com.microsoft.bot.connector.auth.OAuthFlow;
...
public class ApiClient {
    ...
    public void createDefaultAdapter() {
        ...
        String baseUrl = "https://state.botframework.com";
        if(!baseUrl.endsWith("/"))
        	baseUrl = baseUrl + "/";
